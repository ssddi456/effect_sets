...
function get_line_cross_point_2 (
  ...
  //线段ab的法线N1  
  var nx1 = line_a_t_y - line_a_s_y;
  var ny1 = line_a_s_x - line_a_t_x;

  //线段cd的法线N2  
  var nx2 = line_b_t_y - line_b_s_y;
  var ny2 = line_b_s_x - line_b_t_x;
  ...
  //在法线N2上的投影  
  var distC_N2=nx2 * line_b_s_x + ny2 * line_b_s_y;
  var distA_N2=nx2 * line_a_s_x + ny2 * line_a_s_y-distC_N2;  

  //计算交点坐标  
  var fraction= distA_N2 / denominator;  
  var dx= fraction * ny1,  
      dy= -fraction * nx1;  
  return [ (0.5 + line_a_s_x + dx) << 0,
           (0.5 + line_a_s_y + dy) << 0];
}
